...
$(window).load(function(){
  var $post_para = $(".post-para"),
      ...
      // $pre_para.removeClass("invisible"); $digm.text("tlez");
   setTimeout(function(){$pre_para.shuffleLetters({ "text": "Welcome" });$digm.shuffleLetters({ "text": "ttlez" });$digm.text("ttlez");},1000);
   setTimeout(function(){$pre_para.shuffleLetters({ "text": "to" });$digm.shuffleLetters({ "text": "ttlez" });$digm.text("ttlez");},2000);


   setTimeout(function(){$pre_para.addClass("invisible");$post_para.fadeIn(600); $digm.text("ttlez");},3000);
});
